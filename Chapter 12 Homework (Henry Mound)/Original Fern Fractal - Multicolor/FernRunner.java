...
public class FernRunner extends java.applet.Applet implements Runnable
{
   ...
   Color[] cols = {Color.red, Color.blue, Color.orange, Color.pink, Color.blue, Color.yellow, Color.gray};
   ...
   public void init()
   {
      ...
      win.colorList[0] = Color.white;
      win.colorList[1] = Color.red;
   ...
   public void paint( Graphics screen )
   {
      ...
      {
         offscreen.setColor(cols[rand.nextInt(7)]);
